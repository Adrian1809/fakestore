    ...
    <div className="fixed top-0 inset-x-0 h-fit  bg-slate-50 border- borde-zinc-300 z-[10] py-4">
      <nav className="container max-w-7xl h-full mx-auto flex items-center justify-between gap-2">
        ...
        >
          ...
          <p className="hidden text-zinc-900 text-3xl font-medium md:block font-sans">
            FakeStore
          </p>
        ...
        <div className="flex justify-around items-center gap-2 sm:gap-6 text-base font-[300]">
          ...
          >
            ...
            <span className="hidden sm:block font-[300]">Cuenta</span>
          </div>
          <div
            className={cn(
              buttonVariants({ variant: "link" }),
          ...
          >
            ...
            <span className="hidden sm:block font-[300]">Wishlist</span>
          </div>
          <div
            className={cn(
              buttonVariants({ variant: "link" }),
          ...
          >
            ...
            <span className="hidden sm:block font-[300]">Carrito</span>
          </div>
        </div>
      </nav>
      <MyCart />
